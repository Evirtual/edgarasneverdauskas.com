  ...
  return (
    <section className="relative overflow-hidden pt-14 pb-14 md:pt-20 md:pb-16">
      <Container className="relative lg:grid lg:grid-cols-[minmax(0,1fr)_320px] lg:items-center lg:gap-12 xl:grid-cols-[minmax(0,1fr)_380px]">
        ...
        <div className="pointer-events-none absolute inset-y-0 left-1/2 z-0 flex w-[125%] -translate-x-1/2 items-center opacity-[0.32] lg:pointer-events-auto lg:static lg:z-auto lg:w-full lg:translate-x-0 lg:flex-col lg:justify-center lg:gap-4 lg:opacity-100">
          <Globe />
